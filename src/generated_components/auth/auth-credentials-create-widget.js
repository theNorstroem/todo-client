 ...
 * @appliesMixin FBP
 */
export class AuthCredentialsCreateWidget extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-card>
        ...
        <furo-form-layouter>
          ...
          <!-- field: password -->
          <furo-data-text-input condensed ƒ-bind-data="--data(*.password)" ƒ-focus="--focused"></furo-data-text-input> 

          <!-- field: username -->
          <furo-data-text-input condensed ƒ-bind-data="--data(*.username)"></furo-data-text-input> 
        </furo-form-layouter> 
...
window.customElements.define('auth-credentials-create-widget', AuthCredentialsCreateWidget);
