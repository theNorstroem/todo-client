 ...
 * @appliesMixin FBP
 */
export class PersonReferenceCreateWidget extends FBP(LitElement) {
...
window.customElements.define('person-reference-create-widget', PersonReferenceCreateWidget);
