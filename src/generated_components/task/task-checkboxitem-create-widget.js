 ...
 * @appliesMixin FBP
 */
export class TaskCheckboxitemCreateWidget extends FBP(LitElement) {
    ...
    return html`
      ...
      <furo-card>
        ...
        <furo-form-layouter>
          ...
          <!-- field: display_name -->
          <furo-data-text-input condensed ƒ-bind-data="--data(*.display_name)" ƒ-focus="--focused"></furo-data-text-input> 
        </furo-form-layouter> 
...
window.customElements.define('task-checkboxitem-create-widget', TaskCheckboxitemCreateWidget);
